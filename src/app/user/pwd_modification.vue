<template>
    <div>
        <div id="pwd_modification" :span="24">
            <div class="um-title" :span="24">
                <p>修改密码</p>
            </div>
            <el-form class="um-form" :span="24" :model="ruleForm" :rules="rules" ref="ruleForm">
                <div class="form-box">
                    ...
                    <el-form-item class="form-btn" :span="24">
