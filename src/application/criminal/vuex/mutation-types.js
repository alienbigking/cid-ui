...
export const SET_ALL_GENDERS = 'setALLGenders';
export const SET_ALL_ETHNICITIES = 'setALLEthnicities';
export const SET_ALL_NATIONALITIES = 'setALLNationalities';
export const SET_ALL_HOUSEHOLD_REGISTER_TYPES = 'setALLHouseholdRegisterTypes';
export const SET_ALL_POLITICAL_STATUSES = 'setALLPoliticalStatuses';
export const SET_ALL_EDUCATION_DEGREES = 'setALLEducationDegrees';
export const SET_ALL_FLED_TYPES = 'setALLFledTypes';
export const SET_ALL_SEPARATE_MANAGEMENT_LEVELS = 'setALLSeparateManagementLevels';
export const SET_ALL_SEPARATE_CUSTODY_TYPES = 'setALLSeparateCustodyTypes';
export const SET_ALL_COMMUTATION_SCALES = 'setALLCommutationScales';
...
export const SET_ALL_SOMATOTYPES = 'setALLSomatotypes';
export const SET_ALL_FACE_TYPES = 'setALLFaceTypes';
export const SET_ALL_BLOOD_TYPES = 'setALLBloodTypes';
export const SET_ALL_ACCENTS = 'setALLAccents';
