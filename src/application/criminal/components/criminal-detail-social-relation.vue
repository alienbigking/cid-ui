<template>
  <div class="list-box" v-if="socialRelationShow">
    <el-table class="table40" :data="allCriminalSocialRelations" v-loading="loading" header-row-class-name="tableHeader40" style="width:100%">
      <el-table-column   prop="appellation" label="称谓" :show-overflow-tooltip="true" width="80px"> </el-table-column>
      <el-table-column   prop="name" label="姓名" :show-overflow-tooltip="true"  width="80px"> </el-table-column>
      <el-table-column   prop="age" label="年龄" width="50px"> </el-table-column>
      <el-table-column   prop="company" label="公司" :show-overflow-tooltip="true" align="center" width="160px"> </el-table-column>
      <el-table-column   prop="occupation" label="职业" :show-overflow-tooltip="true" width="80px"> </el-table-column>
      <el-table-column   prop="politicalStatusName" label="政治面貌" :show-overflow-tooltip="true" width="100px"> </el-table-column>
