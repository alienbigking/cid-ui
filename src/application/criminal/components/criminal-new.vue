        ...
        <el-form class="form-criminal" :model="criminal" :rules="rules" ref="form" label-position="top">
          <div class="form-box">
            ...
            <el-form-item class="w25" label="性别" prop="genderCode">
              <el-select v-model="criminal.genderCode" value-key="code" :loading="flag.allGenders" placeholder="请选择性别" clearable>
                <el-option v-for="(item, index) in allGenders" :key="index" :label="item.name" :value="item.code"></el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item class="w25" label="民族" prop="ethnicityCode">
              <el-select v-model="criminal.ethnicityCode" :loading="flag.allEthnicities" clearable>
                <el-option v-for="(item, index) in allEthnicities" :key="index" :label="item.name" :value="item.code"></el-option>
              </el-select>
            </el-form-item>
          </div>
          <div class="form-box">
          ...
          <div class="form-box">
            <el-form-item class="w25" label="政治面貌" prop="politicalStatusCode">
              <el-select v-model="criminal.politicalStatusCode" :loading="flag.allPoliticalStatuses" clearable>
            ...
            <el-form-item class="w25" label="文化程度" prop="educationDegreeCode">
              <el-select v-model="criminal.educationDegreeCode" :loading="flag.allEducationDegrees" clearable>
                <el-option v-for="(item, index) in allEducationDegrees" :key="index" :label="item.name" :value="item.code"></el-option>
              </el-select>
            </el-form-item>
...
export default {
  ...
  computed: {
    ...mapState({
      allGenders: state => state.criminal.allGenders,
      allEthnicities: state => state.criminal.allEthnicities,
      occupations: state => state.criminal.occupations,
      allEducationDegrees: state => state.criminal.allEducationDegrees,
      allPoliticalStatuses: state => state.criminal.allPoliticalStatuses,
      allHouseholdRegisterTypes: state => state.criminal.allHouseholdRegisterTypes
    })
  },
  watch: {
    criminal: {
